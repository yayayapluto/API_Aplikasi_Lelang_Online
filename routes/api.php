...
Route::apiResource("auctionContents", \App\Http\Controllers\AuctionContentController::class);
Route::apiResource("auctionPhotos", \App\Http\Controllers\AuctionPhotoController::class);
